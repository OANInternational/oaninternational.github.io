...
export const BLOG_ARTICLES: BlogArticle[] = [
  {
    ...
    title: "OAN International en Magia por Benín",
    description:
      'OAN International recauda más de 2.000 € en el evento solidario "Magia por Benín"',
    content: (
      <div style={wrapper}>
        <p>
          OAN International recauda más de 2.000 € en el evento solidario
          &quot;Magia por Benín&quot;.
        </p>
        <p>
          Durante el pasado fin de semana de marzo, los días 27, 28 y 29,
          participamos activamente en una nueva edición de Magia por Benín,
          evento organizado por Mensajeros de la Paz anualmente y con el que
          colaboramos desde hace años.
        </p>
        <Image
          style={image}
          width="300"
        ...
        />
        <p>
          Desde OAN International, estuvimos presentes con un espacio dedicado
          a la difusión de nuestros proyectos de cooperación para el desarrollo
          en la región de Nikki. El objetivo principal de nuestra participación
          fue doble: sensibilizar a los asistentes sobre nuestra labor en el
          terreno y facilitar el acceso a los productos de Nikarit, nuestro
          proyecto de emprendimiento social.
        </p>
        <h2 style={sectionTitle}>Nikarit: Cosmética con impacto social</h2>
        <p>
          En nuestro puesto informativo, pusimos a disposición del público la
          gama de productos de Nikarit, elaborados de forma artesanal por
          cooperativas de mujeres en Benín. La venta de estos productos no solo
          promueve el comercio justo y el uso de ingredientes naturales como la
          manteca de karité, sino que revierte directamente en la sostenibilidad
          económica de las comunidades productoras.
        </p>
        <Image
          style={image}
          width="300"
        ...
        />
        <h2 style={sectionTitle}>Resultados de la jornada</h2>
        <p>
          Como cada año, la acogida por parte del público ha sido excelente,
          traduciéndose en resultados muy positivos para la organización:
        </p>
        <ul style={answerList}>
          <li>
            <strong>Alcance:</strong> decenas de personas se interesaron por las
            líneas de actuación de OAN International.
          </li>
          <li>
            <strong>Recaudación:</strong> gracias a la venta de productos Nikarit
            y a las donaciones recibidas, logramos alcanzar una cifra superior
            a los 2.000 euros.
          </li>
          <li>
            <strong>Destino de los fondos:</strong> esta cuantía se destinará
            íntegramente a la financiación de los proyectos que lideramos en
            Benín, enfocados en áreas fundamentales como la salud, la educación y
        ...
        />
        <p>
          Queremos expresar nuestro agradecimiento tanto a la organización de
          Magia por Benín por brindarnos este espacio, como a todas las personas
          que se acercaron a nuestro stand para colaborar.
        </p>
        <Image
          style={image}
          width="300"
  ...
  },
  {
    ...
    title: "Encuentro Parakou sobre Karité",
    content: (
      <div style={wrapper}>
        <p>
          El lunes 9 de febrero de 2026 se celebró en Parakou una reunión sobre el
          karité. Se trató de un taller organizado por la AGK acerca de los
          derechos territoriales de las mujeres.
        </p>
        <p>
          El objetivo principal del taller fue encontrar soluciones a los distintos
          problemas relacionados con la tenencia de la tierra, especialmente en lo
          que respecta a las zonas donde las mujeres realizan la recolección.
        </p>
        <p>
          Nuestra compañera Mireille, responsable del proyecto Nikarit, asistió en
          representación de OAN International como entidad con papel importante
          dentro del sector del karité en Benin.
        </p>
        <Image
          style={image}
          width="300"
        ...
        />
        <p>
          Para la puesta en marcha del proyecto, se contó con una estructura
          llamada FARMELINE, creada en Ghana en 2013 con el fin de aumentar la
          productividad de los agricultores en Ghana, Togo y Benín. Esta
          organización llevó a cabo una encuesta en la que se identificaron 4.806
          campos. Primero visitaron a las mujeres recolectoras, quienes las
          guiaron hasta sus zonas de explotación. A partir de la investigación
          desarrollaron una herramienta capaz de reconocer los árboles de karité.
          Con esta herramienta identificaron 91.816 árboles a través de encuestas
          realizadas a 7.050 mujeres, de las cuales 2.000 se encontraban en Benín.
        </p>
        <p>
          Según los resultados, el 37 % de las tierras están gestionadas por
          hombres, el 27 % por mujeres y el 22 % por la comunidad. Sin embargo, la
          encuesta tuvo limitaciones y no tomó en cuenta todos los parámetros
          necesarios, como los árboles jóvenes, los árboles productivos o no
          productivos, ni la distinción entre árboles masculinos y femeninos.
          Tampoco se consideró la titularidad real de las tierras y solo se
          encuestó a mujeres, aunque los hombres también están implicados.
        </p>
        <p>
          Posteriormente tuvo lugar la exposición de una jurista ugandesa sobre la
          situación de la tenencia de la tierra en los países productores de
          karité.
        </p>
        <p>
          A continuación se realizaron trabajos en grupo en torno a cuatro temas
          principales:
        </p>
        <h2 style={sectionTitle}>1. Tenencia de la tierra (acceso a la tierra)</h2>
        <p>
          Desde tiempos antiguos, en la mayoría de los países africanos la herencia
          de la tierra se ha reservado exclusivamente a los hijos varones. Se
          considera que las hijas se casarán y, por tanto, no necesitan tierras,
          ya que beneficiarían a otra familia. El trabajo se llevó a cabo junto con
          el representante del emperador de Nikki y varias mujeres, con el objetivo
          de reflexionar sobre cómo corregir esta injusticia y lograr que las
          hijas sean tratadas en igualdad de condiciones que los hijos. Se señaló
          que la situación empieza a mejorar y que en algunas familias las hijas
          ya reciben el mismo trato. Además, se comprometieron a continuar con la
          labor de incidencia para alcanzar una igualdad generalizada.
        </p>
        <h2 style={sectionTitle}>2. Derechos sobre los árboles</h2>
        <p>
          Se debatió sobre en qué árboles tienen derecho las mujeres a recolectar y
          cuáles son los problemas asociados a la recolección de nueces de karité.
        </p>
        <p>
          Las mujeres pueden recolectar:
        </p>
        <ul style={answerList}>
          <li>En terrenos pertenecientes a sus maridos.</li>
          <li>En terrenos comunitarios.</li>
          <li>
            En parques y bosques autorizados, respetando las medidas forestales,
            incluidos los bosques de galería.
          </li>
          <li>En terrenos privados con autorización de los propietarios.</li>
        </ul>
        <p>Entre los problemas identificados destacan:</p>
        <ul style={answerList}>
          <li>
            Conflictos que pueden llegar a enfrentamientos graves cuando una mujer
            entra en una parcela sin autorización para recolectar.
          </li>
          <li>
            Riesgo de ataques de animales al acceder a parques sin permiso.
          </li>
          <li>
            Violencia conyugal debido a que algunas mujeres priorizan la recolección
            frente a las labores agrícolas. Algunos hombres, como reacción, talan
            árboles o incluso entierran las nueces para impedir la recolección.
          </li>
        </ul>
        <h2 style={sectionTitle}>
          3. Acceso al crédito y a la financiación
        </h2>
        <p>
          Se analizaron los procedimientos para que las mujeres puedan acceder al
          crédito:
        </p>
        <ul style={answerList}>
          <li>Deben organizarse en agrupaciones certificadas o clústeres.</li>
          <li>
            Es necesario contar previamente con contratos de compra firmados para la
            manteca o las almendras de karité.
          </li>
        </ul>
        <p>
          Las mujeres señalaron como principales problemas el desorden en los
          precios de las almendras y la falta de mercado para la manteca. Se les
          recomendó apostar por la calidad tanto de las almendras como de la
          manteca, ya que en años anteriores algunos grandes clientes perdieron la
          confianza debido a la baja calidad del producto y ahora prefieren comprar
          almendras para producir su propia manteca.
        </p>
        <h2 style={sectionTitle}>4. Cartografía digital y próximos pasos</h2>
        <p>
          Se anunció la mejora de la aplicación utilizada, incorporando todos los
          parámetros relacionados con el árbol de karité. Cabe recordar que los
          datos se recopilaron mediante tecnología satelital.
        </p>
        <p>
          Tras todas las consultas y debates, se elaboró una breve hoja de ruta en
          forma de recomendaciones, firmada por todos los participantes, que será
          enviada desde Benín a los organismos financiadores.
        </p>
